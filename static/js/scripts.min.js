            ...
            r.attr("data-component")
                ...
                .forEach(function(e) {
                    if (!(e in App.components))
                        return console.error('Component "' + e + '" is not defined'), !1;
...
(App.components.filters = function(n, e) {
    ...
    return (
        n.find(t.triggerSelector).click(function(e) {
            return e.preventDefault(), n.toggleClass(t.parentActiveClass), !1;
        }), {}
    );
}),
(App.components.image = function(n, e) {
    var t = $.extend({}, { fullscreenActiveClass: "image--show-fullscreen" },
            e
        ),
...
(App.components.header = function(n, e) {
    var t = $.extend({}, { overlayActiveClass: "header-wrapper--show-overlay" },
            e
        ),
    ...
    return (
        ...
        $(document).keyup(function(e) {
            if (27 === e.keyCode) return n.removeClass(t.overlayActiveClass), !1;
        }), {}
    );
}),
(App.components.smoothScroll = function(r, e) {
    var a = $.extend({}, { speed: 500, easing: "swing", scrollOffset: 15 }, e);
    return (
        r.on("click", function(e) {
            ...
            if (
                (n =
                    "undefined" !== (void 0 === t ? "undefined" : _typeof(t)) &&
                    !1 !== t ?
                    this.hash :
                ...
                $("html, body")
                    .stop()
                    .animate({ scrollTop: o.offset().top - a.scrollOffset },
                        a.speed,
                        a.easing,
                        function() {
    ...
    return (
        n.find(t.triggerSelector).on("click", function() {
            ...
            return (
                ...
                (e.removeClass(t.activeClass), n.trigger("closedPage", [e])) :
                (e.addClass(t.activeClass), n.trigger("openedPage", [e])), !1
            );
        }), {}
    );
}),
...
(App.components.comments = function(e, n) {
    e.on("click", function() {
        return (
            $.ajax({
                type: "GET",
                url: "https://ksarvagya.disqus.com/embed.js",
                dataType: "script",
                cache: !0,
            }),
            e.fadeOut(), !1
...
bindComponents();
//# sourceMappingURL=scripts.min.js